...
debug_note = "pmnet"
blender_path = "./blender_files/"
res_path = "./bvh_files/" + debug_note + "/"


directories = sorted([f for f in listdir(blender_path) if isdir(blender_path + f)])
for d in directories:
    files = sorted([f for f in listdir(blender_path + d) if f.endswith(".blend") and not f.startswith(".")])
    for f in files:
        bpy.ops.wm.open_mainfile(filepath=blender_path + d + "/" + f)
        inp_bvh = res_path + d + "/" + f.split(".blend")[0] + "_inp.bvh"
        gt_bvh = res_path + d + "/" + f.split(".blend")[0] + "_gt.bvh"
        ours_bvh = res_path + d + "/" + f.split(".blend")[0] + ".bvh"
        cpy_bvh = res_path + d + "/" + f.split(".blend")[0] + "_cpy.bvh"
        ...
        bpy.data.objects["Text.003"].data.body = "Copy"
        ...
        bpy.data.scenes["Scene"].render.filepath = (
                os.getcwd() + "/videos/" + debug_note + "/" + d + "/" + f.split(".")[0] + ".avi"
        )
        ...
        print(blender_path + d + "/" + f + " processed.")
